...
class HighRes3DNet_MaxCon(BaseNet):
    """
    ...
    def __init__(self,
        ...
        super(HighRes3DNet_MaxCon, self).__init__(
    ...
    def layer_op(self, images, is_training=True, layer_id=-1, **unused_kwargs):
        ...
        # Perform final, over-arching connection
        with DilatedTensor(flow, dilation_factor=1) as dilated4:
            inp_block4 = HighResBlock(
                    params['n_features'],
                    params['kernels'],
                    acti_func=self.acti_func,
                    w_initializer=self.initializers['w'],
                    w_regularizer=self.regularizers['w'],
                    name='{}_m'.format(params['name']))
            inp_res4 = dilated4.tensor
        flow = inp_block4.mega_res(inp_res, inp_res4)
